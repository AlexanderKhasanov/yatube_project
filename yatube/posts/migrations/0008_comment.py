# Generated by Django 2.2.19 on 2023-05-06 20:38
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(help_text='Пост, к которому привязан комментарий', on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='posts.Post', verbose_name='Пост')),
            ],
            options={
                'verbose_name': 'Пост',
